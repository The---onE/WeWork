...
public class Constants {
    public static final String APP_ID = "ohXeiWT8yrGd7fKxS5apqJjS-gzGzoHsz";
    public static final String APP_KEY = "uoU8V7wHrfhIlCglHpkiINLD";
    ...
    public static final String FILE_DIR = "/WeWork";
